...
return [
    ...
    'bootstrappers' => [
        ...
        // Ensures URL generation (route/url/signed routes/mail links) uses the tenant domain.
        App\Tenancy\Bootstrappers\AppUrlBootstrapper::class,
    ...
    'filesystem' => [
         ...
         * 
         * Disabled for Filament compatibility - Filament assets should be global.
         */
